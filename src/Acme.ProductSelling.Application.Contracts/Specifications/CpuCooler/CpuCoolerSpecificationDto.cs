...
{
    public class CpuCoolerSpecificationDto : SpecificationBaseDto
    {
        ...
        public int? TdpSupport { get; set; } // Nullable, W (TDP h? tr?)    
        public int? NoiseLevel { get; set; } // Nullable, dBA (d? ?n)
