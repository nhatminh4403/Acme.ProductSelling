...
namespace Acme.ProductSelling
{
    public class ProductSellingDataSeederContributor : IDataSeedContributor, ITransientDependency
    {
        ...
        public async Task SeedAsync(DataSeedContext context)
        {
            ...
            {
                _computerComponentSeeder.SetDependencies(_categorySeeder.SeededCategories,
                ...
                _peripheralSeeder.SetDependencies(_categorySeeder.SeededCategories,
                                                  _manufacturerSeeder.SeededManufacturers,
                ...
                _coolingSeeder.SetDependencies(_categorySeeder.SeededCategories,
                                               _manufacturerSeeder.SeededManufacturers,
                                               _lookupDataSeeder.FormFactors,
                                               _lookupDataSeeder.Sockets,
